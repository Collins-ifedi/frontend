    ...
    async handleLogin() {
        ...
        try {
            ...
            if (result.success) {
                ...
                // This will display the error message from the backend (e.g., "Incorrect email or password")
                Utils.showToast(result.error, 'error');
            }
        } finally {
    ...
    async handleSignup() {
        ...
        try {
            ...
            if (result.success) {
                ...
                // This will display the error message from the backend (e.g., "User with this email already exists")
                Utils.showToast(result.error, 'error');
            }
        } finally {
